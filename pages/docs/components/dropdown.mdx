...
<Tabs items={['Default', 'Primary', 'Secondary', 'Tertiary', 'Warning']}>
    ...
    <Tabs.Tab>
    ```jsx copy
    <Dropdown variant="primary" label="Primary">
        <DropdownItem>Item 1</DropdownItem>
        <DropdownItem>Item 2</DropdownItem>
        <DropdownItem>Item 3</DropdownItem>
    </Dropdown>
    ...
    <Tabs.Tab>
    ```jsx copy
    <Dropdown variant="secondary" label="Secondary">
        <DropdownItem>Item 1</DropdownItem>
        <DropdownItem>Item 2</DropdownItem>
        <DropdownItem>Item 3</DropdownItem>
    </Dropdown>
    ...
    <Tabs.Tab>
    ```jsx copy
    <Dropdown variant="tertiary" label="Tertiary">
        <DropdownItem>Item 1</DropdownItem>
        <DropdownItem>Item 2</DropdownItem>
        <DropdownItem>Item 3</DropdownItem>
    </Dropdown>
    ...
    <Dropdown variant="tertiary" label="Tertiary">
        ...
        <Tabs.Tab>
    ```jsx copy
    <Dropdown variant="warning" label="Warning">
        <DropdownItem>Item 1</DropdownItem>
        <DropdownItem>Item 2</DropdownItem>
        <DropdownItem>Item 3</DropdownItem>
    </Dropdown>
...
```
<Dropdown variant="primary" label={<>Dropdown<ChevronDown /></>}>
    <DropdownItem>Item 1</DropdownItem>
    <DropdownItem>Item 2</DropdownItem>
    <DropdownItem>Item 3</DropdownItem>
</Dropdown>
