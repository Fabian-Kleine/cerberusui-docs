...
<Tabs items={['Default', 'Primary', 'Secondary', 'Tertiary', 'Warning']}>
    ...
    ```
    <Modal setOpen={() => { }} modalTitle="Default Modal" variant="default" open className='!relative !top-0'> 
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Assumenda, reprehenderit.</p>
    </Modal>
    </Tabs.Tab>
    <Tabs.Tab>
    ...
    ```
    <Modal setOpen={() => { }} modalTitle="Primary Modal" variant="primary" open className='!relative !top-0'> 
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Assumenda, reprehenderit.</p>
    </Modal>
    </Tabs.Tab>
    <Tabs.Tab>
    ...
    ```
    <Modal setOpen={() => { }} modalTitle="Secondary Modal" variant="secondary" open className='!relative !top-0'> 
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Assumenda, reprehenderit.</p>
    </Modal>
    </Tabs.Tab>
    <Tabs.Tab>
    ...
    ```
    <Modal setOpen={() => { }} modalTitle="Tertiary Modal" variant="tertiary" open className='!relative !top-0'> 
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Assumenda, reprehenderit.</p>
    </Modal>
    </Tabs.Tab>
    <Tabs.Tab>
    ...
    ```
    <Modal setOpen={() => { }} modalTitle="Warning Modal" variant="warning" open className='!relative !top-0'> 
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Assumenda, reprehenderit.</p>
    </Modal>
    </Tabs.Tab>
</Tabs>
...
<Modal 
    ...
    modalImage={
        <img src="example.com/your-image.png" />
    } 
    variant="default">
    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Assumenda, reprehenderit.</p>
</Modal>
...
For each **action** you can define an `action` which has the type `Function`, an `actionTitle` which has the type `string` and an `actionVariant` which use the variants from the [Button Component](button).
```jsx copy
<Modal 
...
Mak shure to implement an alternative closing button like shown in [#Actions](#actions).
```jsx copy
<Modal 
